...
3. ไฟล์ table ได้ทำการ export ไว้แล้วชื่อไฟล์ echoHW.sql
4. เวลา run บน broswer ใช้ http://localhost:1323/ ตาม coding ดังนี้
   e.Logger.Fatal(e.Start(":1323"))
5. ในการเชื่อม db ใช้ id เป็น root ส่วน password เป็น 1234 แล้วชื่อ db ใช้เป็น godb ส่วนชื่อ host เป็น localhost port เป็น 3306 ตาม coding ที่ใช้เชื่อม db ต่อไปนี้
